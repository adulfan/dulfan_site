...
module.exports = function() {
	...
	// // block rendering for custom plugin css
	// _helpers.isPluginJS = function(options) {
	// 	var output = '';
	// 		output = scriptTemplate({
	// 			src: "/lightgallery/dist/js/lightgallery.min.js"
	// 		});
	// 	return new hbs.SafeString(output);
	// };

	// // block rendering for custom plugin css
	// _helpers.isPluginCSS = function(options) {
	// 	var output = '';
	// 		output = cssLinkTemplate({
	// 			href: "/lightgallery/src/css/lightgallery.css"
	// 		});
	// 	return new hbs.SafeString(output);
	// };
